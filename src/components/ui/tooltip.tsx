...
const Tooltip = React.memo(function Tooltip({
	...
	// Add debug logging
	// console.log(
	//   `%c[Tooltip ${instanceId}] Rendering with:`,
	//   debugColors.tooltip,
	//   { props, childrenCount: React.Children.count(children) },
	// );
...
const TooltipTrigger = React.memo(function TooltipTrigger({
	...
	// Add debug logging
	// console.log(
	//   `%c[TooltipTrigger ${instanceId}] Rendering with:`,
	//   debugColors.tooltip,
	//   {
	//     props,
...
const TooltipContent = React.memo(function TooltipContent({
	...
	// Add debug logging
	// console.log(
	//   `%c[TooltipContent ${instanceId}] Rendering with:`,
	//   debugColors.tooltip,
	//   {
	//     className,
	//     sideOffset,
